...
function _createBooks() {
    ...
    if (!books || !books.length) {
        ...
        // books.push(_createBook('In Search of Lost Time', 60))
        // books.push(_createBook('Ulysses', 120))
        // books.push(_createBook('Don Quixote', 100))
        // books.push(_createBook('One Hundred Years of Solitude', 150))
